window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		let _deepseek_ai_dsh_client_ui_renderer = require("@deepseek-ai/dsh-client-ui-renderer");
		...
		*/
		...
		function apply(ctx) {
			...
			ctx.slots.inject("settings.general.item", () => ctx.slots.register({
				...
				locale: SETTINGS_NS,
				inject: () => ({
					useCursor: (0, _deepseek_ai_dsh_client_ui_renderer.bindSnapshotSelector)(controller.state),
					setEnabled: (value) => {
